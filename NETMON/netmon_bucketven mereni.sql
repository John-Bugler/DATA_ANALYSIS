...
SELECT r.ConnExternal/50*50 AS BucketVen,
       ...
       MIN(r.RunTsUtc) AT TIME ZONE 'UTC' AT TIME ZONE 'Central European Standard Time' AS PrvniMereniCZ,
       MAX(r.RunTsUtc) AT TIME ZONE 'UTC' AT TIME ZONE 'Central European Standard Time' AS PosledniMereniCZ
